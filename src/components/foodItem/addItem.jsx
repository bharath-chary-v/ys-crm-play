...
export default function AddInstitute({ open, setOpen, foodItemSchema, setFoodItemSchema, submitHandler }) {
  ...
  console.log(foodItemSchema, `selectedPerson`)
  const getData = async () => {
                    ...
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          name="cluster_name"
                          id="cluster_name"
                          value={foodItemSchema.name} // Make sure to bind the input value to the city_name property
                          onChange={(e) => setFoodItemSchema({ ...foodItemSchema, name: e.target.value })}
