...
export default function AddInstitute({ open, setOpen, foodCategorySchema, setFoodCategorySchema, submitHandler }) {
  ...
  const selectedCluster = cluster.find(city => city.id === foodCategorySchema.cluster_id);
  ...
  const handleCityChange = (cityId) => {
    ...
    setFoodCategorySchema({ ...foodCategorySchema, cluster_id: cityId });
  };
  return (
              ...
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:p-6">
                <div className="w-96  border-b border-gray-900/10 pb-12">
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <Combobox as="div" value={foodCategorySchema.cluster_id} onChange={handleCityChange}>
